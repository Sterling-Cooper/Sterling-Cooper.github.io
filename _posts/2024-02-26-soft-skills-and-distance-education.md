...
For software engineers, the medium of communication is asynchronous text. Microsoft Teams and Slack brought text-based group chats to the workplace. Of course, a group chat is very different to a face-to-face conversation. Communication scholars estimate that 60 to 65 percent of the information we receive in any given exchange is communicated nonverbally (Burgoon, Buller, & Woodall, 1996). Can the nature of written language compensate for the lack of in-person cues? Academic research tells us that students can and do overcome the lack of non-verbal communication by establishing familiarity through the use of greetings, encouragement, and personal disclosure (Garrison 2011).
